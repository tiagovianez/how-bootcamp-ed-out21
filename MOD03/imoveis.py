...
#%%
imovel_id = 0
json_data = get_json(url, imovel_id, headersList, payload) # Leitura do requests sobre a variavel "json_data"
while len(json_data['search']['result']['listings']) > 0:   # Validando o tamanho da variável
...
# %%
# Salvando em um DB
df.to_csv('house_db.csv', sep=';', index=False)
